"""
Direct truth-table inference solver — infer2 (VSIDS hot_pos) plus
empirically frequency-ordered s-value enumeration.

Observation from 300 benchmark problems: negative offsets appear ~2x more
often than positive ones in arity-3 rules, and s=0 never appears in arity-3.
Enumerating by decreasing empirical frequency puts the correct s-triple much
earlier in the search, dramatically reducing bit-checks at fixed budget.

S_ORDER_A2: arity-2 offset order (from training frequency)
S_ORDER_A3: arity-3 offset order (s=0 omitted — never seen in arity-3 rules)
"""
